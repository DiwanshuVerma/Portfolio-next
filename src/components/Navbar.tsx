    ...
    return (
        <Container>
            <motion.nav
                ...
                className={clsx(
                    "max-w-3xl fixed top-2 inset-x-0 z-20 mx-auto flex items-center justify-center gap-1 sm:gap-4 px-4 py-2 sm:py-3 h-12 rounded-full border shadow dark:shadow-[1px_1px_6px_0px_rgba(125,125,214,0.50)] backdrop-blur bg-white/50 dark:bg-neutral-950/50 border-neutral-300 dark:border-none text-black dark:text-white transition-all ",
                    scrolled ? "w-[80%] md:w-[40%] duration-500" : "w-[90%] md:w-[75%] duration-500"
                )}
            >
